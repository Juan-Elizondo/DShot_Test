                                   ...
                                   const void *primary_data, size_t data_size, rmt_encode_state_t *ret_state)
{
    ...
    make_dshot_frame(&frame, throttle->throttle, throttle->telemetry_req, throttle->bidirectional);
...
esp_err_t rmt_new_dshot_esc_encoder(const dshot_esc_encoder_config_t *config, rmt_encoder_handle_t *ret_encoder, bool TXS_Buffer)
{
    ...
    ESP_GOTO_ON_FALSE(dshot_encoder, ESP_ERR_NO_MEM, err, TAG, "no mem for dshot esc encoder");
